...
## Change Log
- 2026-01-08: Resolve relative `SYNC_CONFIG_PATH` against current working directory and repository root; loader now falls back to repo root when the CWD candidate is missing. README updated to 
...
- 2026-01-01: Clarified README examples to show when share/role flags are optional vs. pulled from `sync_config.json` for both Team Space and personal flows.document behavior.
